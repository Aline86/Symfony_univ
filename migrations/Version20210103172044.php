 ...
 */
final class Version20210103172044 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE article (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, title VARCHAR(255) NOT NULL COLLATE BINARY, content CLOB NOT NULL COLLATE BINARY, created_at DATETIME NOT NULL, author VARCHAR(255) NOT NULL COLLATE BINARY, nb_views INTEGER NOT NULL, published BOOLEAN NOT NULL, updated_at DATETIME DEFAULT NULL)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE article');
        $this->addSql('CREATE TABLE article (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, title VARCHAR(255) NOT NULL, content CLOB NOT NULL, author VARCHAR(255) NOT NULL, nb_views INTEGER NOT NULL, published BOOLEAN NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, user_id INTEGER DEFAULT NULL)');
